...
/**
 * The main functionality of an AvitaElement. Initializes the element and provides methods to manipulate its properties.
 * @param tag The HTML tag name of the element to create.
 * @returns An object with methods to manipulate the element's properties.
 */
export default function avitaCreate<T extends HTMLElement>(
    ...
    return {
        ...
        /**
         * Appends the provided `AvitaElement` instances as children to the current `AvitaElement` instance.

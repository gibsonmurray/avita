...
export default interface AvitaElement<T extends HTMLElement> {
    ...
    onKeyPress: (callback: (event: KeyboardEvent) => void) => AvitaElement<T>
    ...
    onDoubleClick: (callback: (event: MouseEvent) => void) => AvitaElement<T>
    ...
    onContextMenu: (callback: (event: MouseEvent) => void) => AvitaElement<T>

    // Pointer Events
    onPointerOver: (callback: (event: PointerEvent) => void) => AvitaElement<T>
    onPointerEnter: (callback: (event: PointerEvent) => void) => AvitaElement<T>
    onPointerDown: (callback: (event: PointerEvent) => void) => AvitaElement<T>
    onPointerMove: (callback: (event: PointerEvent) => void) => AvitaElement<T>
    onPointerUp: (callback: (event: PointerEvent) => void) => AvitaElement<T>
    onPointerCancel: (
        callback: (event: PointerEvent) => void
    ) => AvitaElement<T>
    onPointerOut: (callback: (event: PointerEvent) => void) => AvitaElement<T>
    onPointerLeave: (callback: (event: PointerEvent) => void) => AvitaElement<T>
    onGotPointerCapture: (
        callback: (event: PointerEvent) => void
    ) => AvitaElement<T>
    ...
    onTouchCancel: (callback: (event: TouchEvent) => void) => AvitaElement<T>
    ...
    /* -- CSS PROPERTIES -- */
    accentColor: (value: Color | string) => AvitaElement<T>
    ...
    animationIterationCount: (value: AnimationIterationCount) => AvitaElement<T>
    animationName: (value: string) => AvitaElement<T>
    animationPlayState: (value: AnimationPlayState) => AvitaElement<T>
    animationTimingFunction: (value: AnimationTimingFunction) => AvitaElement<T>
    ...
    backgroundColor: (value: Color | string) => AvitaElement<T>
    backgroundImage: (value: URL | Color | string) => AvitaElement<T>
    ...
    borderBlockColor: (value: Color | string) => AvitaElement<T>
    borderBlockEnd: (value: string) => AvitaElement<T>
    borderBlockEndColor: (value: Color | string) => AvitaElement<T>
    ...
    borderBlockStartColor: (value: Color | string) => AvitaElement<T>
    ...
    borderBottomColor: (value: Color | string) => AvitaElement<T>
    ...
    borderColor: (value: Color | string) => AvitaElement<T>
    ...
    borderInlineColor: (value: Color | string) => AvitaElement<T>
    borderInlineEnd: (value: string) => AvitaElement<T>
    borderInlineEndColor: (value: Color | string) => AvitaElement<T>
    ...
    borderInlineStartColor: (value: Color | string) => AvitaElement<T>
    ...
    borderLeftColor: (value: Color | string) => AvitaElement<T>
    ...
    borderRightColor: (value: Color | string) => AvitaElement<T>
    ...
    borderTopColor: (value: Color | string) => AvitaElement<T>
    ...
    caretColor: (value: Color | string) => AvitaElement<T>
    clear: (value: Clear) => AvitaElement<T>
    clipPath: (value: string) => AvitaElement<T>
    color: (value: Color | string) => AvitaElement<T>
    ...
    columnRuleColor: (value: Color | string) => AvitaElement<T>
    ...
    outlineColor: (value: Color | string) => AvitaElement<T>
    ...
    textDecorationColor: (value: Color | string) => AvitaElement<T>
    ...
    textEmphasisColor: (value: Color | string) => AvitaElement<T>
